...
#define AI_SINEWAVE_MODEL_SIGNATURE     "0x5b3f8f730ddb6a4c8344c45de900efc0"
...
#define AI_TOOLS_DATE_TIME   "Sun May  5 19:39:55 2024"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    128, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINEWAVE_IN_NUM, &serving_default_dense_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINEWAVE_OUT_NUM, &gemm_2_output),
  &gemm_0_layer, 0x7d5fb4aa, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_sinewave_activations_map, 1, params)) {
    ...
    serving_default_dense_input0_output_array.data = AI_PTR(g_sinewave_activations_map[0] + 60);
    serving_default_dense_input0_output_array.data_start = AI_PTR(g_sinewave_activations_map[0] + 60);
